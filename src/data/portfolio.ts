...
export const skills: SkillsGroup[] = [
  ...
  {
    label: 'DOMAINS',
    primary: ['Computer Vision', 'Artificial Intelligence', 'Frontend Development'],
    secondary: ['Backend Development', 'Electronics', 'Agile SCRUM', 'Kanban'],
  },
]

export const contactLinks: ContactLink[] = [
  { label: 'EMAIL', value: 'henriqfvr@gmail.com', href: 'mailto:henriqfvr@gmail.com' },
  { label: 'GITHUB', value: 'github.com/henriqfranco', href: 'https://github.com/henriqfranco' },
  {
    label: 'LINKEDIN',
